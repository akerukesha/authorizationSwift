...
SWIFT_CLASS("_TtC13Authorization11AppDelegate")
...
@interface UIViewController (SWIFT_EXTENSION(Authorization))
- (void)showAlertMessageWithTitle:(NSString * _Nonnull)title message:(NSString * _Nonnull)message;
@end
